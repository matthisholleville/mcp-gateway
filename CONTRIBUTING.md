...
- If you are looking for something to work on, check out our [open issues](https://github.com/matthisholleville/mcp-gateway/issues).
...
## Releasing
Releases of MCP Gateway are done using [Release Please](https://github.com/googleapis/release-please) and [GoReleaser](https://goreleaser.com/). The workflow looks like this:
